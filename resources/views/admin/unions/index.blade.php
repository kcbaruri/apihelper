                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:(0);">{{ __('sidebar.unions') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 text-right p-0">
                                        <a class="btn btn-primary" data-toggle="" href="{{ route('admin.unions.create') }}">
                                            <i class="fa fa-plus"> </i> <span>{{ __('pages.add_new') }} </span>
                                        </a>
                                    </div>
                                    <div class="search-area">
                                        <h2>{{ __('pages.search') }}</h2>
                                        <form action="{{ route('admin.unions') }}" method="get">
                                        ...
                                        <table class="datatable table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <?php if(count($unions) > 0) {
                                                    $counter = 0;
                                                    foreach($unions as $union) { $counter++; ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="#"><?php echo $union->name; ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo $union->thana->name;?></td>
                                                    <td><?php echo $union->district->name;?></td>
                                                    <td><?php echo $union->division->name;?></td>
                                                    <td style="max-width:220px; white-space: normal;"><?php  echo $union->description; ?></td>                                                 
                                                    <td class="">
                                                        <div class="actions">
                                                            <a class="btn btn-sm bg-success-light" href="{{ route('admin.unions.edit', $union->id) }}">
                                                                <i class="fe fe-pencil"></i> {{ __('pages.edit') }}
                                                            </a>
                                                            <form action="{{ route('admin.unions.delete', $union->id) }}" method="post" class="btn-group">
                                                            {{ csrf_field() }}
