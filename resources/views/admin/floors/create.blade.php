                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('pages.add_floor') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('pages.new_floor') }}</h4>
                                </div>
                                @if ($errors->any())
                                ...
                                @endif
                                <div class="card-body">
                                    <form enctype="multipart/form-data" action="{{ url()->route('admin.floors.store') }}" method="post">
                                        {{ csrf_field() }}
