                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('pages.new_upazila') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('pages.new_upazila') }}</h4>
                                </div>
                                @if ($errors->any())
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ url()->route('admin.thanas.store') }}" method="post">
                                        {{ csrf_field() }}
