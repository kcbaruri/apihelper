...
<html>
   ...
   <div style="text-align: center;" >
         ...
         <hr/>
         <h2 style="color:#6f6f6f;margin:0"><span>{{ __('reports.upazila_rpt_header') }}</span></h2>
      </div>
      ...
      <table width="100%" cellpadding="5px" cellspacing="0" style="background-color: #fff;padding: 20px;border-radius: 5px;box-shadow: 0px 0px 5px 0px #8c8989;">
        ...
        <th width="30%">{{ __('sidebar.districts') }}</th> 
        <th width="30%">{{ __('sidebar.divisions') }}</th> 
        </tr>
        <?php 
        $i = 1;
        foreach($thanas as $var){
            ...
            <td width="20%"><?php echo $var->name;?></td>
