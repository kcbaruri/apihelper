            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">{{ __('pages.update_vata') }}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('/admin')}}">{{ __('sidebar.vatatypes') }}</a></li>
                                    <li class="breadcrumb-item active">{{ __('pages.update_vata') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('pages.update_vata') }}</h4>
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.vatatypes.update', $vatatype->id) }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                            <textarea class="form-control" rows ="6" placeholder="Description" id="description" name="description"><?php echo $vatatype->description;?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <option value="{{ $var->id }}" <?php if($var->id == $vatatype->department_id) echo "selected=selected"; else echo "";?>>{{ $var->name }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
