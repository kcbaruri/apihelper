                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:(0);">{{ __('sidebar.divisions') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 text-right p-0">
                                        <a class="btn btn-primary" data-toggle="" href="{{ route('admin.divisions.create') }}">
                                        ...
                                        <table class="datatable table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <?php if(count($divisions) > 0) {
                                                    $counter = 0;
                                                    foreach($divisions as $division) { $counter++; ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="#"><?php echo $division->name;?></a>
                                                        </h2>
                                                    </td>                                                    
                                                    <td style="max-width:220px; white-space: normal;"> <span><?php echo $division->description; ?></span></td>                                                    
                                                    <td class="">
                                                        <div class="actions">
                                                            <a class="btn btn-sm bg-success-light" href="{{ route('admin.divisions.edit', $division->id) }}">
                                                                <i class="fe fe-pencil"></i> {{ __('pages.edit') }}
                                                            </a>
                                                            <form action="{{ route('admin.divisions.delete', $division->id) }}" method="post" class="btn-group">
                                                            {{ csrf_field() }}
