                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('pages.edit_tenant') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('pages.edit_tenant') }}</h4>
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="card-body">
                                    <form action="{{ url()->route('admin.tenants.update', $tenant->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <label class="switch">
                                                <input type="checkbox" name="is_master" id="is_master" <?php if($tenant->is_master == 1) echo "checked=checked"; ?> onchange="showHideControls()">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="radio">
                                                    <label>
                                                        <input  type="radio" name="gender" class="radio" value="Male" <?php if($tenant->gender == 'male') echo "checked=checked"; ?>> Male
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input  type="radio" name="gender" class="radio" value="Female" <?php if($tenant->gender == 'female') echo "checked=checked"; ?>> Female
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input  type="radio" name="gender" class="radio" value="Other" <?php if($tenant->gender == 'other') echo "checked=checked"; ?>> Other
                                                    </label>
                                                </div>                          
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Date of birth" id="dob" name="dob" required="required" value="<?php echo $tenant->dob ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Mobile number" id="mobile_number" name="mobile_number" value="<?php echo $tenant->mobile_number; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-2">{{ __('pages.email') }}</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Email" id="email" name="email" value="<?php echo $tenant->email; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Permanent Address" id="permanent_address" name="permanent_address" value="<?php echo $tenant->permanent_address; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Advance amount" id="advance_amount" name="advance_amount"  value="<?php echo $tenant->advance_amount; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Payment due date" id="payment_due_date" name="payment_due_date" value="<?php echo $tenant->payment_due_date; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="In Date" id="in_date" name="in_date" value="<?php echo $tenant->in_date ;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Out Date" id="out_date" name="out_date" value="<?php echo $tenant->out_date ;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hiden_class" style ="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="Number of family member(s)" id="no_of_family_members" name="no_of_family_members" value="<?php echo $tenant->no_of_family_members; ?>">
                                            </div>
                                        </div>
