                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('pages.add_village') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('pages.new_village') }}</h4>
                                </div>
                                @if ($errors->any())
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ url()->route('admin.villages.store') }}" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <select name="thana_id" id="thana_id" class="form-control" required="required" onchange="getUnion(this.value,'union_id','')">
